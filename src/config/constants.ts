...
export const DB_URL = 'mongodb://localhost/distribuidora-nest';
...
export const DEFAULT_USERNAME = 'DEFAULT_USERNAME';
export const DEFAULT_FIRSTNAME = 'DEFAULT_FIRSTNAME';
export const DEFAULT_LASTNAME = 'DEFAULT_LASTNAME';
